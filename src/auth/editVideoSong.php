...
<body>
    <div class="container">
        ...
        <table align="center" border="1" style="border-color: #fff;" class="displaySong">
            ...
            <?php foreach ($songs as $index => $song) : if ($index == 5) break; ?>
                <tr>
                    ...
                    <td><a style="padding: 5px; background-color: #66FF33; color: #fff; border-radius: 15px; text-decoration: none;" href="insertVideoSong.php?id=<?php echo $song['id'] ?>">Update</a></td>
        ...
        <div class="c3"><a href=insertVideoSong.php>INSERT SONG</a></div>
